...
class NetworkModule {
    ...
    @Singleton
    @Provides
    internal fun provideHttpClient(interceptor: MockHttpInterceptor): OkHttpClient {
        return OkHttpClient.Builder().addInterceptor(interceptor).build()
    }

    @Singleton
    @Provides
    internal fun provideMockHttpInterceptor(context: Context): MockHttpInterceptor {
        return MockHttpInterceptor(context)
    }
}